...
const GET_PANELS = "https://0ie94ovk74.execute-api.us-east-1.amazonaws.com/prod/grafana_subscribed_panels";

const MonitorSubscribed = ({ apiId, subId }) => {
...
export default MonitorSubscribed
