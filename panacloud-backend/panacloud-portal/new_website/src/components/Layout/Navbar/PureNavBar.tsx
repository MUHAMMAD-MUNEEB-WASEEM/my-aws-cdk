...
import { Add, Message, Notifications, ArrowDropDown, Menu, Lock } from "@material-ui/icons";
...
/////////////////////////////////////////   MiddleNav   ///////////////////////////////////////////////////////
// export interface MiddleNavProps { pages: { name: string, url: string }[], currentPath: string }
...
/////////////////////////////////////////   RightNav   ///////////////////////////////////////////////////////
// export interface RightNavProps { authData?: { username: string, heroImageUrl: string }, currentPath: string }
    ...
    if (authData && authData.username) {
        return (
            <div className={classes.heroSection} data-testid='hero-section' {...others}  >
                {widthUnder940px ?
                    <div> <IconButton size='small' ><Avatar src={authData.heroImageUrl} /></IconButton> </div> :
                    <>
                        <div className={classes.heroAvatar} > <Avatar src={authData.heroImageUrl} /><Typography>{authData.username}</Typography> </div>
                        ...
                        <div><IconButtonC><ArrowDropDown /></IconButtonC></div>
                    </>
                }
            </div>
        )
