...
interface ApiDetailsInterface {
    ...
    apiKind: ApiContentProps['apiKind'];
    ownerName: ApiContentProps['ownerName'];
    createdAt: string;
}
...
const ApiDetails: FC<RouteComponentProps> = ({ }) => {
    ...
    const { apiKind, ownerName, imageUrl, publishDate, ratings, title } = mockData[0];
                ...
                <Grid xs={8} item >
                    <Grid container >
                        <Grid container item xs={10} direction='column' >
                            <ApiContent apiKind={apiKind} title={title} ownerName={ownerName} imageUrl={imageUrl} />
                        </Grid >
...
const ApiContent: FC<ApiContentProps> = ({ title, ownerName, apiKind }) => {
    return (
        <div >
            <Typography color='textPrimary' variant='h5' component='h3' >
                <b>{title}</b>
            </Typography>
            <Typography color='textSecondary' >By {ownerName}</Typography>
