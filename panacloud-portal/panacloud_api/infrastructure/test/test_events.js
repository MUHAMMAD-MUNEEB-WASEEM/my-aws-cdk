// I generated this event by using the SAM CLI. by using `sam local generate-event appsync resolver`
module.exports = {
  sample_event: {
    arguments: {
      id: "my identifier",
    ...
    request: {
      headers: {
        ...
        referer:
          "https://us-west-1.console.aws.amazon.com/appsync/home?region=us-west-1",
