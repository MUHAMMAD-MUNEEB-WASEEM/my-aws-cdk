...
export const Header: FC<{ authstate: AuthState }> = ({ authstate }) => {
    return (
        <Grid container style={{ marginBottom: '20px' }} >
            ...
            <Grid item xs={1} container justify="flex-end" alignContent='flex-start' >{(authstate === 'SIGNED_IN') && <AddNewApiButton />}</Grid>
        </Grid>
    )
}
