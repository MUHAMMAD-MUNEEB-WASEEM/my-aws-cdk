...
# Scenario Outline: CREATE NEW SHOW MORE RECOMMENDATION REQUESTS SENT QUERY ERROR WHEN userId= <userId> and pageNumber= <pageNumber> and pageSize= <pageSize>

#  * text query = 
# """query showMoreRecommendationRequestsSent($input:showMoreRecommendationRequestsSentInput!) {
#   showMoreRecommendationRequestsSent(input: $input) {
#     count
#     requests {
#       id
#       message
