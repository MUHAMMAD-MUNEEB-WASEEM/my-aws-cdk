...
export async function fetchAllPublicApis(g: gremlin.process.GraphTraversalSource<gremlin.process.GraphTraversal>, data: FetchAllPublicApisInput) {

  let { pageSize, pageNumber,apiType } = data;
