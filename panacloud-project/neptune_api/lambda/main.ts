...
import { createCompany, updateCompanyInfo, addUserToCompany, updateProfilePicture, changeEntityProfileStatus } from './mutations/entity'
...
import { fetchMyCompanies, getEntityProfile, getUsersList } from "./queries/entity"
        ...
        try {
            switch (event.info.fieldName) {
                ...
                case "fetchAllPublicApis":
                    return await fetchAllPublicApis(g, event.arguments.input);
                ...
                case "fetchApiInfo":
                    return await fetchApiInfo(g, event.arguments.input, event.identity.username);
                ...
                case "getEntityProfile":
                    return await getEntityProfile(g, event.arguments.input, event.identity.username);
                ...
                case 'getUsersList':
                    return await getUsersList(g, event.arguments.input)
